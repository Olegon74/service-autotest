package ru.test.serviceautotests.api.tests;
...
import ru.test.serviceautotests.api.clients.shell.TabControllerClient;
import ru.test.serviceautotests.api.models.TabRequest;
import ru.test.serviceautotests.api.requests.CreateTabRequestBuilder;
import ru.test.serviceautotests.api.response.CreateTabResponse;
import ru.test.serviceautotests.api.response.TabResponse;

import java.util.Arrays;
import java.util.List;

import static ru.test.serviceautotests.api.assertions.Conditions.hasStatusCode;
